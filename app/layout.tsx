    ...
    <html lang="en" suppressHydrationWarning>
      <body
        className={cn(
          ...
          "mx-4 mb-40 mt-8 flex max-w-4xl flex-col md:flex-row lg:mx-auto",
          bodyFont.variable,
          monoFont.variable
        )}
      >
        <ThemeProvider attribute="class" defaultTheme="system" enableSystem>
          <main className="mx-auto mt-6 flex min-w-0 max-w-2xl flex-auto flex-col px-2 md:mt-0 md:px-0">
            <Navigation />
            {children}
            <Footer />
          </main>
