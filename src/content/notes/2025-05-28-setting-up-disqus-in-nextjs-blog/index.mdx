---
slug: "setting-up-disqus-in-nextjs-blog"
...
![`parseColor` Error](./parseColor-error.webp "parseColor error in console")

This happens because Disqus validates color values and expects them to be in RGB or Hex format.

![Disqus code checks for RGB/Hex](./disqus-code-ref.webp "Disqus code checks for RGB/Hex")
