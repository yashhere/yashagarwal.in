---
slug: "setting-up-hugo-automatic-deployment-to-github-with-wercker"
...
![Wercker → Registry → steps](./wercker-steps.webp "Wercker → Registry → steps")
