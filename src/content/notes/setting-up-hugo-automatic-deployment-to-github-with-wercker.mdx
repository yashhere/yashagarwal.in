...
![Wercker → Registry → steps](/images/notes/setting-up-hugo-automatic-deployment-to-github-with-wercker/wercker-steps.webp "Wercker → Registry → steps")
...
![Wercker Pipeline](/images/notes/setting-up-hugo-automatic-deployment-to-github-with-wercker/wercker-pipeline.webp "Wercker Pipeline")

You need to generate a new access token for your deploy stage from Github
settings.
![Github Access Token](/images/notes/setting-up-hugo-automatic-deployment-to-github-with-wercker/wercker-access-token.webp "Github Access Token")

After adding the deploy stage, add the token you obtained from the Github to
Environmental Variables in deploy pipeline.

![Wercker Token](/images/notes/setting-up-hugo-automatic-deployment-to-github-with-wercker/wercker-token.webp "Wercker Token")
