---
slug: "fixing-hindi-fonts-in-arch-linux"
...
![before applying the fix](./hindi_font_before.webp "before applying the fix")
...
![after applying the fix](./hindi_font_after.webp "after applying the fix")
