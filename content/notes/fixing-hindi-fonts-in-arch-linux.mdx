...
![before applying the fix](/images/posts/fixing-hindi-fonts-in-arch-linux/hindi_font_before.png "before applying the fix")
...
![after applying the fix](/images/posts/fixing-hindi-fonts-in-arch-linux/hindi_font_after.png "after applying the fix")
