...
category: Technology
description: >-
  A quick guide to fix distorted Hindi font rendering in Arch Linux browsers,
  enhancing readability and user experience.
updatedOn: "2025-05-29T16:18:19+05:30"
_categorized: cca696bb12f0f7279590a286c970485d
---

When viewing Hindi content in any browser in Arch Linux, the rendering looks
weird.

![before applying the fix](/images/notes/fixing-hindi-fonts-in-arch-linux/hindi_font_before.webp "before applying the fix")
...
![after applying the fix](/images/notes/fixing-hindi-fonts-in-arch-linux/hindi_font_after.webp "after applying the fix")
