...
createdOn: 2024-02-27T108:45:15.000Z
status: published
series:
  order: 1
  title: Homelab Tales
...
Being a backend developer, although the sysadmin, devops, networking, and platform skills don't bring any apparent advantages to my day-to-day work, I have decided to invest some time in homelabbing because -
...
3. As I progress in my career, I will not be handling just one portion of the product. I intend to take more and more responsibilities. That means wearing more than one hats. A homelab provides me an opportunity to learn one such skill.
