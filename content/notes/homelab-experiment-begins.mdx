...
createdOn: 2024-02-27T12:15:15.000Z
status: published
series:
  order: 1
  title: Homelab Tales
tags:
  - Homelab
  - Networking
updatedOn: 2024-02-27T06:45:02.000Z
---
...
Being a backend developer, although the Networking, automation, and infra skills don't bring any apparent advantage in my day-to-day work, but still, I have decided to invest some time in it because -

1. It is my long time passion and I want to experience it.
...
3. As I progress in my career, I will not only be handling one portion of the product. I intend to take more and more responsibilities. That means wearing more than one hats. A homelab provides me an opportunity to learn one such skill.
...
1. Create a fully-reproducible setup (using Docker, Ansible etc.)
2. Allow outside world access to some of the services and secure your server.
3. Learn to configure VPN and also learn the theory.
