...
![`parseColor` Error](/images/notes/setting-up-disqus-in-nextjs-blog/parseColor-error.webp "parseColor error in console")

This happens because Disqus validates color values and expects them to be in RGB or Hex format.

![Disqus code checks for RGB/Hex](/images/notes/setting-up-disqus-in-nextjs-blog/disqus-code-ref.webp "Disqus code checks for RGB/Hex")
