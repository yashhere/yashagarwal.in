...
published: 2019-02-17T14:44:56+05:30
status: "published"
series:
  order: 2
...
In the last [post](/blog/go-grpc-opa-a-perfect-union-part-1/), we discussed about the structure of our library
...
gRPC uses protocol buffers for serializing structured data. To define the structure of the data that you want to serialize, we use a _proto_ file - it is a simple text file that contains all the logical pieces of your data in the form of _messages_, and the methods that will be called over the network. To know more about the syntax of proto files, visit [this](https://grpc.io/docs/guides/) link.
...
The authentication logic in real-world scenarios will determine the _who_ part.
