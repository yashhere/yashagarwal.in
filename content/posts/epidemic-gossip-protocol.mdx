...
published: 2020-04-14T08:38:15+05:30
status: "published"
---
...
Let' take a close look at how a virus spreads. I'll explain it using a small sample of five people. We assume that, initially, none of these people is infected. Now, because of some external factors, one of these (say $A$) got infected with the virus. We say that $A$ is **_infected_**, and the remaining four people are **_susceptible_** to infection. $A$ followed the advice of doctors and isolated itself from the group. Now we say that $A$ is **_removed_** (either because he has the infection, but is not spreading it, or because he is recovered).
...
The concept of the Gossip Protocol is not something new. The 1987 [paper](https://dl.acm.org/doi/10.1145/41840.41841) Epidemic algorithms for replicated database maintenance is considered seminal on this topic. The Gossip Protocols were initially used to maintain consistency in replicated databases for efficient data communication. Later, these protocols found their usage in other areas such as service discovery in a distributed environment and maintaining node memberships as well.
