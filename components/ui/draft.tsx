...
export default function Draft({ children }: Props) {
  return (
    <>
      <div className="mt-16 flex flex-col items-center gap-8 rounded border py-16 text-center shadow-md">
        <div className="">
          <FiPenTool className="size-28 text-primary" />
        </div>
        <div className="text-6xl font-semibold text-primary sm:text-7xl">
          Work in Progress
        </div>
