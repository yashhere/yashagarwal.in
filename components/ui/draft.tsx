...
export default function Draft({ children }: Props) {
  return (
    <>
      <div className="bg-background border-border mt-16 flex flex-col items-center gap-8 rounded-sm border py-16 text-center shadow-md">
        <div className="">
          <HammerIcon className="text-foreground-accent size-28" />
        </div>
        <div className="text-foreground-accent text-6xl sm:text-7xl">
          Work in Progress
        </div>
