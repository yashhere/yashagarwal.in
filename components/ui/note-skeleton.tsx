export const NoteSkeleton = () => {
  return (
    <div className="flex">
      <div className="hover:bg-accent flex w-full flex-col items-start gap-0 rounded-lg px-4 py-2 transition-all duration-200 select-none md:flex-row md:items-center md:gap-2">
