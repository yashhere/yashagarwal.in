      ...
      <div className="mx-auto max-w-2xl space-y-8 p-4 md:px-0">
        <div className="flex flex-row flex-wrap items-start justify-between md:flex-row">
          <section className="flex flex-col  ">
            <h1 className="mb-4 text-lg font-bold">Follow Me!</h1>
              ...
              {Socials.map((s) => {
                return (
                  <Link
                    ...
                    aria-label={s.name}
                    noExternalLinkIcon
                    className="flex flex-row items-center gap-4 text-text/60 md:gap-2"
                  >
          ...
          <section className="flex w-1/3 flex-col md:w-auto ">
            <h1 className="mb-4 text-lg font-bold">Browse more</h1>
